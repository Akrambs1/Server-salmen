...
def check_website(url):
    try:
        ...
        print("Website is down. Sending email notification and WhatsApp message.")
        send_email(
            "Prolegal Down", "The server of salmen. so please call IT team (Akram ben salem) to fix it and thanx")
        send_whatsapp_message(
            f"{whatsapp_sender_name}: Prolegal Down. The server of salmen. so please call IT team (Akram ben salem) to fix it and thanx.")
